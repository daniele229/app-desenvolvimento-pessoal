...
import { Brain, Heart, Sparkles, Smile, Frown, Meh, Plus, Calendar } from "lucide-react"
...
const meditations: Meditation[] = [
  { id: "1", title: "Calma Interior", theme: "Ansiedade", duration: "10 min", description: "Meditação para acalmar a mente ansiosa" },
  { id: "2", title: "Foco Total", theme: "Concentração", duration: "15 min", description: "Desenvolva foco e clareza mental" },
  { id: "3", title: "Amor Próprio", theme: "Autoestima", duration: "12 min", description: "Cultive amor e aceitação por si mesmo" },
  { id: "4", title: "Gratidão Diária", theme: "Gratidão", duration: "8 min", description: "Pratique gratidão e abundância" },
  { id: "5", title: "Sono Profundo", theme: "Relaxamento", duration: "20 min", description: "Prepare-se para uma noite tranquila" },
]
        ...
        <TabsContent value="meditacoes" className="space-y-4">
          <Card className="border-purple-200 dark:border-purple-900/30">
            <CardHeader>
              ...
              <CardDescription>Escolha uma meditação guiada por tema</CardDescription>
            </CardHeader>
            <CardContent>
              <ScrollArea className="h-[500px] pr-4">
                <div className="space-y-3">
                  {meditations.map((meditation) => (
                    <Card key={meditation.id} className="bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-950/20 dark:to-indigo-950/20 hover:shadow-md transition-shadow">
                      <CardContent className="p-4">
                        <div className="flex justify-between items-start mb-2">
                          <div className="flex-1">
                            <h3 className="font-semibold text-purple-700 dark:text-purple-400">{meditation.title}</h3>
